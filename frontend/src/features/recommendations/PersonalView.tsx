          ...
          {hasResults ? (
            <>
              ...
              <div className="final-choice-bar">
                ...
                <button className="primary-button" onClick={onConfirmSelection} disabled={!selectedItem?.menuId || isLoading || isConfirmingSelection}>
                  {isConfirmingSelection ? "저장 중" : "선택 확정"}
                </button>
              </div>
            </>
          ) : (
